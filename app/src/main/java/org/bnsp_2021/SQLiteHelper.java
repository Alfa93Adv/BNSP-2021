...
class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        sql = "INSERT INTO "+TABLE_KEUANGAN+" ("+Table_Column_ID+","+Table_Column_Simbol+", "+Table_Column_Tanggal+", "+Table_Column_Nominal+", "+Table_Column_Keterangan+", "+Table_Column_Status+") " +
                "VALUES ('1', '[ + ]','10-05-2021', 100000, 'mendapatkan uang saku ', 'android.resource://org.bnsp_2021/drawable/leftarrow')," +
                "('2', '[ - ]','10-11-2021', 90000, 'membeli hp', 'android.resource://org.bnsp_2021/drawable/rightarrow')," +
                "('3', '[ - ]','10-05-2021', 15000, 'membeli makan', 'android.resource://org.bnsp_2021/drawable/rightarrow')," +
                "('4', '[ + ]','10-05-2021', 3500, 'membeli minum', 'android.resource://org.bnsp_2021/drawable/leftarrow')," +
                "('5', '[ - ]','10-05-2021', 10000, 'membeli makan', 'android.resource://org.bnsp_2021/drawable/rightarrow');";
        db.execSQL(sql);
